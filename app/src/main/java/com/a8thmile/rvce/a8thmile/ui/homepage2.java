...
import android.view.View;
        ...
        import com.a8thmile.rvce.a8thmile.ui.ContentFragment;
        import yalantis.com.sidemenu.util.ViewAnimator;
        import com.a8thmile.rvce.a8thmile.R;


public class homepage2 extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener {
    private DrawerLayout drawerLayout;
    private ActionBarDrawerToggle drawerToggle;
    private List<SlideMenuItem> list = new ArrayList<>();
    private ContentFragment contentFragment;
    private ViewAnimator viewAnimator;
    private int res = R.drawable.otp;//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contentFragment = ContentFragment.newInstance(R.drawable.otp);//
    ...
    private void createMenuList() {
        SlideMenuItem menuItem0 = new SlideMenuItem(ContentFragment.CLOSE, R.drawable.ic_clear_white_36dp);//
        list.add(menuItem0);
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        this.res = this.res == R.drawable.otp ? R.drawable.otp : R.drawable.otp;//music-film-music
